...
function NotificationCompose() {
  ...
  return (
    <div className="absolute  bottom-0 left-1/2 -translate-x-1/2 z-50">
      <div className=" relative sm:w-56 w-32 bg-slate-900 px-2 sm:py-1.5 py-1 rounded-t-md flex items-center justify-start">
        ...
        <button
          className="sm:ms-3 ms-2 hidden sm:block"
