...
function MailList({ data }) {
  ...
  return (
    <>
      <div
        onClick={() => dispatch(GeneralAction.openReading({ data }))}
        className=" bg-white bg-opacity-90 hover:bg-opacity-100 transition-all duration-100 mb-2.5 max-h-28 overflow-hidden drop-shadow-xl rounded-md py-1 px-2"
      >
